...
insert into customer (addr, phone, birth, custid, custname) values('대한민국 부산', '01098765432', '2001-04-21', 'wow', '이지은');

-- 여러 튜플 동시 추가
insert into customer values ('lu', "강해원", "미국 뉴욕", "01022223333", "2002-03-04"),
('luc', "강해", "미국 뉴욕", "01022223333", "2002-03-04"),
('luck', "해원", "미국 뉴욕", "01022223333", "2002-03-04");
...
-- 주문 테이블에서 상품의 총 판매 개수 검색 + 의미있는 열 이름을 변경
select sum(amount) as 'total_amount' from orders;

-- 주문 테이블에서 총 판매 개수, 평균 판매 개수, 상품 최저가
select sum(amount) as 'total_amount', avg(amount) 'avg_amount',
